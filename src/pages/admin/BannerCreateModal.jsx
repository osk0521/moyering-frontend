      ...
      <div className="banner-modal-containerHY">
        ...
        <div className="banner-modal-bodyHY">
          <div className="banner-formHY">
            ...
            {/* 날짜 설정 */}
            <div className="form-rowHY">
              <div className="form-groupHY">
                <label className="form-label requiredHY">시작일</label>
                <input
                  type="date"
                  name="startDate"
                ...
                />
                {errors.startDate && <span className="error-messageHY">{errors.startDate}</span>}
              </div>
              <div className="form-groupHY">
                <label className="form-label requiredHY">종료일</label>
                <input
                  type="date"
                  name="endDate"
                ...
                />
                {errors.endDate && <span className="error-messageHY">{errors.endDate}</span>}
              </div>
            </div>

            {/* 사용 여부 */}
            <div className="form-groupHY">
              <label className="form-labelHY">사용 여부</label>
              <div className="radio-groupHY">
                <label className="radio-labelHY">
                  <input
                    type="radio"
                    name="use_yn"
                    value="Y"
                    ...
                    onChange={handleInputChange}
                  />
                  <span className="radio-textHY">사용</span>
                </label>
                <label className="radio-labelHY">
                  <input
                    type="radio"
                    ...
                    onChange={handleInputChange}
                  />
                  <span className="radio-textHY">중지</span>
                </label>
              </div>
            </div>
          </div>
