...
export default function ProfileManagement() {
  ...
  const submit = () => {
    ...
    myAxios(token).post("/host/hostProfileUpdate",user.hostId,{params})
    .then(res=>{
      console.log(res);
    })
    .catch(err=>{
      ...
      <div className="KHJ-host-profile-container">
        ...
        <form className="KHJ-host-profile-form">
          <div className="KHJ-host-profile-group KHJ-host-image-upload">
            <label>프로필 사진</label>
            <img src={host.profile || ''} alt="프로필" className="KHJ-host-profile-image" name="profile"  />
            <div className="KHJ-host-file-box">
              <input type="text" placeholder="첨부파일" readOnly onChange={handleInputChange}/>
