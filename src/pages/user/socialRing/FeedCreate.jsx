                        ...
                        <div className="KYM-FeedCreate-tag-list">
                            {tags.map(t => (
                                ...
                                >
                                    {t}
                                    <button
                                        className="KYM-FeedCreate-tag-remove carousel-remove button_osk"
                                        type="button"
...
// export default function HostFeedCreate({ onClose }) {
//     const user = useAtomValue(userAtom);
//     const [token, setToken] = useAtom(tokenAtom);
//     const navigate = useNavigate();
...
//             navigate(`/hostFeed/${res.data}`); // 작성 후 상세페이지 이동
//         } catch (err) {
...
//         <div className="KYM-FeedCreate-container">
//             <div className="KYM-FeedCreate-header">
//                 <button className="KYM-FeedCreate-btn-cancel" onClick={onClose}>취소</button>
//                 <div className="KYM-FeedCreate-title">
